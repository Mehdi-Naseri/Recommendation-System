...
{
    [Area("UkRetail")]
    public class SequentialNotPurchasedEvaluationController : Controller
    {
        private readonly ApplicationDbContext _dbContext;
        public SequentialNotPurchasedEvaluationController(ApplicationDbContext context)
        {
            _dbContext = context;
        }
    ...
    .Where(a => a.InvoiceDate >= trainStartDate && a.InvoiceDate <= trainEndDate &&
            ...
            int recInfoid = _dbContext.RecommendationInfo.First(a => string.Equals(a.RecName, "SpmNotPurchased10Month")).RecId;
