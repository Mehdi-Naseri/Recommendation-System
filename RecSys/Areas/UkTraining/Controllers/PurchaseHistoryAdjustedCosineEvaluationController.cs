...
{
    [Area("UkTraining")]
    public class PurchaseHistoryAdjustedCosineEvaluationController : Controller
    {
        private readonly ApplicationDbContext _dbContext;
        public PurchaseHistoryAdjustedCosineEvaluationController(ApplicationDbContext context)
        {
            _dbContext = context;
        }
        ...
        {
            string recType = "PurchaseFrequency10Month";
