...
{
    [Area("UkTraining")]
    public class CollaborativeAdjustedCosineEvaluationController : Controller
    {
        private readonly ApplicationDbContext _dbContext;
        public CollaborativeAdjustedCosineEvaluationController(ApplicationDbContext context)
        {
            _dbContext = context;
        }
        ...
        {
            string recType = "Cf10MonthAdjusted";
