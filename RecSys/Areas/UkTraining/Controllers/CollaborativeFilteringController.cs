...
namespace RecSys.Areas.UkTraining.Controllers
{
    ...
    public class CollaborativeFilteringController : Controller
    {
        ...
        {
            int recInfoid = _dbContext.RecommendationInfo.First(a => string.Equals(a.RecName, "Cf10Month")).RecId;
            ...
            recInfoid = _dbContext.RecommendationInfo.First(a => string.Equals(a.RecName, "PurchaseFrequency10Month")).RecId;
            //Clean table
            _dbContext.Recommendation.RemoveRange(_dbContext.Recommendation.Where(r => r.RecommendationInfoId == recInfoid));
            ...
            recInfoid = _dbContext.RecommendationInfo.First(a => string.Equals(a.RecName, "CfNotPurchased10Month")).RecId;
