...
{
    [Area("UkRec")]
    public class SequentialRecNotPurchasedController : Controller
    {
        private readonly ApplicationDbContext _dbContext;
        public SequentialRecNotPurchasedController(ApplicationDbContext context)
        {
            _dbContext = context;
        }
        ...
        public IActionResult Recommendations(float supportPercentage, int confidence, DateTime startDate, DateTime endDate)
        {
            ...
            List<RecommendedItems> recommendedItemsList = sequentialRecommendation.RecommendNotPurchased(sequenceSupports2Items, userSequences, 50);
        ...
        {
            int recInfoid = _dbContext.RecommendationInfo.First(a => string.Equals(a.RecName, "SpmNotPurchased11Month")).RecId;
            //Clean table
        ...
        private List<SequenceSupport> ReadFrequentSequences()
        {
            ...
            var a = _dbContext.FrequentSequentialPattern.Where(r => r.Train == false); 
